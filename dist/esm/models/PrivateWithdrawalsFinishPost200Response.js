 ...
 */
export function instanceOfPrivateWithdrawalsFinishPost200Response(value) {
...
export function PrivateWithdrawalsFinishPost200ResponseFromJSON(json) {
    return PrivateWithdrawalsFinishPost200ResponseFromJSONTyped(json, false);
}
export function PrivateWithdrawalsFinishPost200ResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PrivateWithdrawalsFinishPost200ResponseToJSON(json) {
    return PrivateWithdrawalsFinishPost200ResponseToJSONTyped(json, false);
}
export function PrivateWithdrawalsFinishPost200ResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
