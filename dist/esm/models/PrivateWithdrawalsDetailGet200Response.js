 ...
 */
export function instanceOfPrivateWithdrawalsDetailGet200Response(value) {
...
export function PrivateWithdrawalsDetailGet200ResponseFromJSON(json) {
    return PrivateWithdrawalsDetailGet200ResponseFromJSONTyped(json, false);
}
export function PrivateWithdrawalsDetailGet200ResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PrivateWithdrawalsDetailGet200ResponseToJSON(json) {
    return PrivateWithdrawalsDetailGet200ResponseToJSONTyped(json, false);
}
export function PrivateWithdrawalsDetailGet200ResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
